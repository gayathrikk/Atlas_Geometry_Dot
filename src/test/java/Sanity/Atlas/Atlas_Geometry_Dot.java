...
public class Atlas_Geometry_Dot {
...
//	    	 clickElementByXpath("(//i[@role='presentation'])[7]", "node3");
		...
		@Test(priority=8)
		public void geometry_Dot() throws InterruptedException
		{
			clickElementByXpath("(//nb-icon[@pack='nebular-essentials'])[3]", "Geometry");
			clickElementByXpath("(//span[@class='inner-circle'])[1]", "Dot");
